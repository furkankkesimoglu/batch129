...
public class Arrays04 {
    ...
    public static void main(String[] args) {
       ...
       //Note: Elelmanlari almaya son elemandan baslayacagim icin for-each-loop kullanamam bu yuzden for-loop kullandim.
        for (int i = color.length-1 ; i >= 0 ; i--) {

            if(color[i].equals( "Yellow")){ //equals ==> aynidir anlaminda
                break;
            }
        ...
        //2.Yol:
       //Yellow elemaninin index'ini bul ve o index'den daha buyuk index'e sahip olan elemanlari yazdiriniz.
