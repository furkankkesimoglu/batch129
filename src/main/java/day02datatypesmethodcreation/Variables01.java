...
public class Variables01 {
    ...
    //float: Virgullu sayilar(Ondalik Sayilar - Decimal Numbers) icin kullanilir.(Fiyatlandirmalarda - 12.99)
    //double: Virgullu sayilar(Ondalik Sayilar - Decimal Numbers) icin kullanilir.(Hucre Agirligi : 0.000000000112)

    //Note: primitive data type'lerini java olusturmustur, biz olusturamayiz
    //Note: primitive data type'lerinin isimlerinde sadece kucuk harf kullanilir
    ...
    public static void main(String[] args) {
        ...
        System.out.println(weightCell - weightAmip);//8.9E-11 ==> 8.000000000000089 ==> "8.9 carpi 10 uzeri -14" "E ==> Exponent"
