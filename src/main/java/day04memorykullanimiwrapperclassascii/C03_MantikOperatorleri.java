...
public class C03_MantikOperatorleri {
    ...
    // 10 < sayi (Mantik Operatorleri) sayi < 20
    //== Esittir icin cift esittir = tek esittir atama(assigment) yapar.
    /*
   ...
   &' de ise tum kodu tarar sonra durur.
   buda &&'nin tek &'den daha hizli calismasini saglar.


   || veya operatoru Pollyannicidir. En ufak bir pozitiflikten true doner.
