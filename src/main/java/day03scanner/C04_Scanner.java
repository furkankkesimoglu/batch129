...
public class C04_Scanner {
    ...
    public static void main(String[] args) {
        ...
        // Ornek= Kullanicidan alacaginiz 5 basamakli bir sayinin ilk iki ve son iki basamagindaki rakamlarin toplamini yazdiran kodu yaziniz.

        // input==>12345 ==> 1+2+3+4+5=
        // output ==> 12

        Scanner input = new Scanner(System.in);
        System.out.println("Lutfen 5 basamakli bir sayi griniz..");
